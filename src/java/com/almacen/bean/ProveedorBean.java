...
public class ProveedorBean {
    ...
    boolean verFac = false;
    boolean verBusqueda = true;
    ...
    public boolean isVerFac() {
        return verFac;
    }

    public void setVerFac(boolean verFac) {
        this.verFac = verFac;
    }
    ...
    public void verFactura(Factura seleccionFact){
        System.out.println("*****proveedor -->>" + seleccionFact.getProveedor().getProveedor());
        verFac = true;
        verBusqueda = false;
    ...
    public void editaFactura(){
        try{
            ...
            Proveedor p = provDao.encuentraUnProv(idProv);
    ...
    public void guardarArticuloEdita(){
        ...
        try{
            ...
            Double cuni=0.0, ctdadE=0.0 , ctotal=0.0, totalp=0.0, cpieza=0.0;
            ...
            Factura fac = facturaDAO.encuentraUnaFac(factura.getIdFactura());
            ...
            cuni= cu.doubleValue();
            ctdadE = canti.doubleValue();
            ctotal = cuni * ctdadE;
            //ct = cu.multiply(canti);
            System.out.println("*** lo que tiene ctdad--->>"+ctdadE);
            ...
            //depto = departamentoDAO.encuentraUnDepto(fac.getDepartamento().getIdDepartamento());
            System.out.println("*** lo que tiene ctdad--->>"+ctdadE);
            //BigDecimal tmp = new BigDecimal(ctdadE);
